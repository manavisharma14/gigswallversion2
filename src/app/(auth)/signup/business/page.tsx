...
<p className="text-sm text-white/80 mt-2">
  ...
  <a href="/signup/student" className="underline hover:text-white">
    Student Signup
  </a>
</p>
    </div>
  ...
  return (
    <div className="flex items-start gap-2 mt-2 text-sm">
      ...
      <label htmlFor="terms" className="text-white/90 leading-snug">
        I agree to the{" "}
        <a href="/terms" target="_blank" className="underline text-white hover:text-gray-200">
          Terms & Conditions
        </a>{" "}
        and{" "}
        <a href="/privacy" target="_blank" className="underline text-white hover:text-gray-200">
          Privacy Policy
        </a>.
      </label>
    </div>
