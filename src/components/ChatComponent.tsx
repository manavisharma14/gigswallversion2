...
const ChatComponent = ({
  ...
  useEffect(() => {
    const storedUserId = localStorage.getItem("userId");
    console.log("[ChatComponent] Loaded userId:", storedUserId);
    if (storedUserId) setUserId(storedUserId);
  }, []);
  ...
  useEffect(() => {
    ...
    console.log("[ChatComponent] Setting up listener for room:", roomId);
    ...
    const unsub = onSnapshot(q, (snapshot) => {
      ...
      console.log("[ChatComponent] Fetched messages:", msgs);
      setMessages(msgs);
    });
